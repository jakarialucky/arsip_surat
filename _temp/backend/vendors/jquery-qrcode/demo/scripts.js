    ...
    function (e, t, n) {
        (function (e) {
            function n() {
                ...
                o.each(a, function (e, t) {
                    ...
                    (e = {
                        ...
                        radius: 0.01 * parseInt(o("#radius").val(), 10),
                        quiet: parseInt(o("#quiet").val(), 10),
                        mode: parseInt(o("#mode").val(), 10),
                        mSize: 0.01 * parseInt(o("#msize").val(), 10),
                        mPosX: 0.01 * parseInt(o("#mposx").val(), 10),
                        mPosY: 0.01 * parseInt(o("#mposy").val(), 10),
                        label: o("#label").val(),
                        fontname: o("#font").val(),
            ...
            function t() {
                ...
                t.files &&
                    t.files[0] &&
                    (((e = new r.FileReader()).onload = function (e) {
