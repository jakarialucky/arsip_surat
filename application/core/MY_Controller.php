...
class Frontend extends CI_Controller
{
  ...
  public function __construct($config = array())
  {
    ...
    $this->load->library(array("Template", "Template_front", "Userize", "form_validation", "security", "user_agent", "Encryption", "My_encrypt"));
    $this->load->helper(array("app_front", "sct", "public", "language"));
