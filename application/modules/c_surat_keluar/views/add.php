    ...
    <div class="card m-b-30">
     <!--  <div class="card-header bg-primary text-white">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            <label>Kepada</label>
            <input type="text" class="form-control form-control-sm" placeholder="Kepada" name="kepada" id="kepada">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="file" name="img" class="file-upload-default" data-id="berkas_surat_keluar"/>
            <div class="input-group col-xs-12">
              <input type="hidden" class="file-dir" name="file-dir-berkas_surat_keluar" data-id="berkas_surat_keluar"/>
              <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="berkas_surat_keluar" placeholder="Berkas surat keluar" readonly name="berkas_surat_keluar" />
