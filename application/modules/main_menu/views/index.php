                ...
                <li class="dd-item" data-id="<?= $menu->id_menu ?>">
                  <div class="dd-handle">
                    ...
                    <div class="float-right dd-nodrag">
                      ...
                      <a href="<?= url("main_menu/update/" . enc_url($menu->id_menu)) ?>" class="badge badge-primary"><i class="fas fa-pencil-alt"></i> <?= cclang("update") ?></a>
                      ...
                      <li class="dd-item" data-id="<?= $sub_menu->id_menu ?>">
                        <div class="dd-handle">
                          ...
                          <div class="float-right dd-nodrag">
                            ...
                            <a href="<?= url("main_menu/update/" . enc_url($sub_menu->id_menu)) ?>" class="badge badge-primary"><i class="fas fa-pencil-alt"></i> <?= cclang("update") ?></a>
