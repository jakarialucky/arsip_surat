...
class User extends Backend
{
    ...
    if ($this->input->is_ajax_request()) {
      ...
      if ($this->form_validation->run()) {
        ...
        $insert = array(
          ...
          // 'kode_ruangan' => implode(",", $this->input->post('kode_ruangan', true)),
  ...
  function update($id)
  {
    ...
    if ($row = $this->model->get_where_data(dec_url($id))) {
      ...
      $data = array(
        'action' => url("user/update_action/$id"),
        'button' => "update",
  ...
  function update_action($id)
  {
    if ($this->input->is_ajax_request()) {
      ...
      if ($this->form_validation->run()) {
        ...
        // $update['kode_ruangan']  = implode(",", $this->input->post('kode_ruangan', true));
