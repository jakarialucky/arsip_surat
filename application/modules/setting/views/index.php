        ...
        <div class="card-body">
          ...
          <?php if (is_allowed("config_view_default")) : ?>
            ...
            <table class="table table-striped mb-6 table-hover">
              <tr>
                <th class="table-title"><?= cclang("title") ?> Web/App</td>
                <td>
              ...
              <tr>
                <th class="table-title">Url/Domain</td>
                <td>
              ...
              <tr>
                <th class="table-title"><?= cclang("owner") ?></td>
                <td>
              ...
              <tr>
                <th class="table-title"><?= cclang("phone") ?></td>
                <td>
              ...
              <tr>
                <th class="table-title"><?= cclang("address") ?></td>
                <td>
