    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php if (is_allowed("config_view_core")) : ?>
          <table class="table table-striped mb-6 table-hover">
            <tr>
              <th class="table-title"><?= cclang("time_zone") ?></td>
              <td>
            ...
            <tr>
              <th class="table-title">Encryption Key</td>
              <td>
            ...
            <tr>
              <th class="table-title">Encryption Url</td>
              <td>
            ...
            <tr>
              <th class="table-title">Url suffix</td>
              <td>
            ...
            <tr>
              <th class="table-title">Route admin</td>
              <td>
            ...
            <tr>
              <th class="table-title">Route login</td>
              <td>
            ...
            <tr>
              <th class="table-title">Max Upload</td>
              <td>
            ...
            <tr>
              <th class="table-title"><?= cclang("language") ?></td>
              <td>
            ...
            <tr>
              <th class="table-title"><?= cclang("user_log_activity") ?></td>
              <td>
            ...
            <tr>
              <th class="table-title"><?= cclang("maintenance") ?></td>
              <td>
