      ...
      <div class="card-body">
        ...
        <?php if (is_allowed("config_view_sosmed")) : ?>
          <table class="table table-striped mb-6 table-hover">
            <tr>
              <th class="table-title"><i class="ti-facebook cl-facebook"></i> Facebook</td>
              <td>
            ...
            <tr>
              <th class="table-title"><i class="ti-instagram cl-instagram"></i> Instagram</td>
              <td>
            ...
            <tr>
              <th class="table-title"><i class="ti-youtube cl-youtube"></i> Youtube</td>
              <td>
            ...
            <tr>
              <th class="table-title"><i class="ti-twitter cl-twitter"></i> Twitter</td>
              <td>
