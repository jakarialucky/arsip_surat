<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated fadeIn delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-2">
          <a href="<?= url("ruangan/filter/") ?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i> Filter</a>
        </div>

        <form autocomplete="off" class="content-filter">
          <div class="row">
            <div class="form-group col-md-12">
              <input type="text" id="kode_ruangan" class="form-control form-control" placeholder="Kode ruangan/gedung/alat" />
            </div>       
            <div class="col-md-12">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    table = $('#table').DataTable({
      ...
      "ajax": {
        "url": "<?= base_url('publish/pages/json') ?>",
        "type": "POST",
        "data": function(data) {
          data.kode_ruangan = $("#kode_ruangan").val();
          data.nama_ruangan = $("#nama_ruangan").val();
          data.nama_gedung = $("#nama_gedung").val();
        }
      },
