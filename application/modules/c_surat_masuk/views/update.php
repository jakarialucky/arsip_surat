      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control form-control-sm select2" data-placeholder=" -- Select -- " name="sifat_surat" id="sifat_surat">
              <option value=""></option>
              <option <?=($sifat_surat == "umum" ? "selected":"")?> value="umum">Umum</option>
          ...
          <div class="form-group">
            ...
            <input type="file" name="img" class="file-upload-default" data-id="berkas_surat_masuk"/>
            <div class="input-group col-xs-12">
              <input type="hidden" class="file-dir" name="file-dir-berkas_surat_masuk" data-id="berkas_surat_masuk"/>
              <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="berkas_surat_masuk" placeholder="Berkas surat masuk" readonly name="berkas_surat_masuk" value="<?=$berkas_surat_masuk?>" />
